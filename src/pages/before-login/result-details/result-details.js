    ...
    <Layout isFederal={false} isProfessional={true}>
      <div className={Styles.mainContainer}>
        <div className={Styles.searchCriteria}>
          <Text className={Styles.departHead} variant={"mlgText"} color="darkGray">Search Criteria “ Department of the Army ”</Text>
          <div className='dFlex'>
              ...
              <>
                <Grid item lg={4} sm={12} md={4} xs={12}>
                  <div className={Styles.trendingBox} >
                    <div>
                      <Text className={`${Styles.requestText} ${'mt5 mB5 ml15'}`} strong='strong3' variant={"smText"} color="gray">Trending Assets</Text>
                      <Card className={Styles.cardBoxOne} >
                    ...
                    <div>
                      <Text className={`${Styles.requestText} ${'mt5 mB5 ml15'}`} strong='strong3' variant={"smText"} color="gray">Child Offices</Text>
                      <Card className={`${Styles.cardthirdBox} ${Styles.scrollBar} ${'pt24 pb20'} `} >
                      {childList.map((value) => (
                      <CardItems
