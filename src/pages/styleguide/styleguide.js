    ...
    return (
        <div className={Styles.wrapper}>
            ...
            <div className='mt40 mb50'>
                <ContactCard src={"assets/images/OfficialArmySeal.png"} imageClass={"ml20"} isGreenBorder={false} istopLacsText={true} isArlingtonText={false} isVirgina={true} imageSize="imgLarge" />
            </div>
            <div className='mt40 mb50'>
                <ContactCard src={"assets/images/armySeal.png"} imageClass={"mt10 mr10 w75px"} departmentClass={Styles.departmentArmyTab} istopLacsText={false} isDownLacsText={true} isContactIcon={false} isGreenBorder={true} imageSize="imgLarge" />
            </div>
            {/* army card */}
            <div className='mt40 mb50'>
                <Criteria />
            ...
            <Card className={Styles.cardBox} >
                <CardItems isPosition={true} isAssetsText={false} isChildText={false} isContactText={false} accountOne={"2021-2021"} accountTwo={"Tom Jones"}  icon1={"linkedIn"} icon2={"envelope"} icon3={"phone"} icon4={"userinfo"} color1="lightGray01" />
                <CardItems isPosition={true} isAssetsText={false} isChildText={false} isContactText={false} accountOne={"2021-2021"} accountTwo={"Jeff Koons"}  icon1={"linkedIn"} icon2={"envelope"} icon3={"phone"} icon4={"userinfo"}color1="lightGray01" />
                <CardItems isPosition={true} isAssetsText={false} isChildText={false} isContactText={false} accountOne={"2021-2021"} accountTwo={"Dale Strong"}  icon1={"linkedIn"} icon2={"envelope"} icon3={"phone"} icon4={"userinfo"}color1="lightGray01" />
                <CardItems isPosition={true} isAssetsText={false} isChildText={false} isContactText={false} accountOne={"2021-2021"} accountTwo={"Janice Yellen"}  icon1={"linkedIn"} icon2={"envelope"} icon3={"phone"} icon4={"userinfo"} color1="lightGray01" />
                <CardItems isPosition={true} isAssetsText={false} isChildText={false} isContactText={false} accountOne={"2021-2021"} accountTwo={"William Ford"}  icon1={"linkedIn"} icon2={"envelope"} icon3={"phone"} icon4={"userinfo"} color1="lightGray01" />
                <CardItems isPosition={true} isAssetsText={false} isChildText={false} isContactText={false} accountOne={"2021-2021"} accountTwo={"Tom Jones"}  icon1={"linkedIn"} icon2={"envelope"} icon3={"phone"} icon4={"userinfo"} color1="lightGray01" />
            </Card>
