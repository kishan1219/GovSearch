    ...
    return (
        <Layout isHeader={false} isTechnomile={true} isSidebar={false} isFederal={false} isGovSearchProfessional={true}>
            <div className={Styles.wrapper}>
                ...
                {/* Main Heading Box End Here  */}
                <Heading className={Styles.suiteHead} color={"secondary"} >Intelligence Suite</Heading>
                {/* MainBox started Here  */}
                <div className={`${Styles.MainBox} ${'mt25'}`}>
                                    ...
                                    <div className={Styles.comptetiveCard} >
                                        ...
                                        <div className={Styles.contentBox} >
                                            ...
                                            <Text className={Styles.identityText} variant={"mlgText"} color={"gray"} strong={"strong4"}>
                                                Easily identify new opportunities and sharpen win strategies.<NavLink to="/" style={{ color: "gray" }}>Learn More</NavLink></Text>
                                        </div>
                                    </div>
                                </Card>
                            </Grid>
                            {/* First Grid Card End Here */}
                            <Grid item lg={6} sm={12} md={6} xs={12} >
                                <Card className={Styles.accountCard} >
                                    <div className={Styles.comptetiveCard} >
                                        <div className={Styles.imageCard}>
                                        ...
                                        <div className={Styles.contentBox} >
                                            ...
                                            <Text className={Styles.identityText} variant={"mlgText"} color={"gray"} strong={"strong4"}>
                                                Reach the right decision makers with your BD and marketing efforts.
                                            </Text>
                                        </div>
                                    </div>
                                </Card>
                                ...
                                <Card className={Styles.accountCard} >
                                    <div className={Styles.comptetiveCard} >
                                        ...
                                        <div className={Styles.contentBox} >
                                            ...
                                            <Text className={Styles.identityText} variant={"mlgText"} color={"gray"} strong={"strong4"}>
                                            Transform BD and capture processes and boost win rates
                                            </Text>
                                        </div>
                                    </div>
                                </Card>
                                ...
                                <Card className={Styles.accountCard} >
                                    <div className={Styles.comptetiveCard} >
                                        ...
                                        <div className={Styles.contentBox} >
                                            ...
                                            <Text className={Styles.identityText} variant={"mlgText"} color={"gray"} strong={"strong4"}>
                                            Strenger enpand Customer streamline task order management.
                                            </Text>
                                        </div>
                                    </div>
                                </Card>
                                ...
                                <Card className={Styles.accountCard} >
                                    <div className={Styles.comptetiveCard} >
                                        ...
                                        <div className={Styles.contentBox} >
                                            ...
                                            <Text className={Styles.identityText} variant={"mlgText"} color={"gray"} strong={"strong4"}>
                                            Securaly efficentialy and streamline task order management.
                                            </Text>
                                        </div>
                                    </div>
                                </Card>
                                ...
                                <Card className={Styles.accountCard} >
                                    <div className={Styles.comptetiveCard} >
                                        ...
                                        <div className={Styles.contentBox} >
                                            ...
                                            <Text className={Styles.identityText} variant={"mlgText"} color={"gray"} strong={"strong4"}>
                                            streamline and acclerate Agreement review and negotiations cycles.
                                            </Text>
                                        </div>
                                    </div>
                                </Card>
                                ...
                                <Card className={Styles.accountCard} >
                                    <div className={Styles.comptetiveCard} >
                                        ...
                                        <div className={Styles.contentBox} >
                                            ...
                                            <Text className={Styles.identityText} variant={"mlgText"} color={"gray"} strong={"strong4"}>
                                            Save Hours off contracts sets up and shift your focus to risk management
                                            </Text>
                                        </div>
                                    </div>
                                </Card>
