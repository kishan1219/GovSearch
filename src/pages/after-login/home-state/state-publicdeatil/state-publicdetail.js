...
import Styles from "./state-publicdetail.module.scss";
...
import { ContactCardData } from "./state-publicdata";
const StatePublicdetail = () => {
              ...
              {showHide && (
                <div className={Styles.detaisFirst}>
                  ...
                  {ContactCardData.map((data) => {
                    const { secretary, madisonCounty } = data;

                    return (
                      <div key={madisonCounty}>
                        <CriteriaCard
                          src={madisonCounty.logo}
                          isCriteriaSecond={false}
                          heading={madisonCounty.heading}
                          addrsFirst={madisonCounty.addressFirst}
                          addrsSecond={madisonCounty.addressSecond}
                          contactFirst={madisonCounty.contactNumberFirst}
                          webAddress={madisonCounty.webAddress}
                          contactSecond={madisonCounty.contactNumberSecond}
                          // employee={madisonCounty.employee}
                          // description={madisonCounty.description}
                        />
                      </div>
                    );
                  })}
...
export default StatePublicdetail;
