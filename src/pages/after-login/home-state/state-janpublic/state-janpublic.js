...
import Styles from "./state-janpublic.module.scss";
import {
  Button,
  Card,
  CheckBox,
...
import { JanPublicData } from "../../../search-result/search-data";
import { useNavigate } from "react-router-dom";
const StateJanPublic = () => {
      ...
      <div className={Styles.container}>
        <div className={Styles.searchCriteria}>
          <Text variant={"mlgText"} color="darkGray">
            Search Criteria “Jan Public Affairs Montgomery Alabama”
          </Text>
          <div className="dFlex">
