...
import Styles from "./federal-publicdetail.module.scss";
...
import { ContactCardData } from "./federal-publicdata";
const FederalPublicDetail = () => {
              ...
              {showHide && (
                <div className={Styles.detaisFirst}>
                  ...
                  {ContactCardData.map((data) => {
                    const { baeSystem, secretary } = data;
                    ...
                    return (
                      <div key={secretary}>
                        <CriteriaCard
                          ...
                          heading={secretary.heading}
                          addrsFirst={secretary.addressFirst}
                          addrsSecond={secretary.addressSecond}
                          // hideTxtFst={"https://army.mil"}
                          // hideTxtSec={"100,000"}
                         
                          contactFirst={secretary.contactNumberFirst}
                          webAddress={secretary.webAddress}
                          contactSecond={secretary.contactNumberSecond}
...
export default FederalPublicDetail;
