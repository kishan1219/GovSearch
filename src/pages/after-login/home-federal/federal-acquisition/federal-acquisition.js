...
import Styles from "./federal-acquisition.module.scss";
import {
  Button,
  Card,
  CheckBox,
    ...
    <Layout isFederal={false} isProfessional={true}>
      <div className={Styles.container}>
        <div className={Styles.searchCriteria}>
          ...
          Search Criteria “Acquisition, Logistics, and Technology Army” 
          </Text>
          <div className="dFlex">
...
export default FederaleAcquisition;
